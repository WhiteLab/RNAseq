...
if __name__ == "__main__":
    ...
    (novosort, sample, log_dir, t, mem, stype) = (inputs.novosort, inputs.sample, inputs.log_dir, inputs.t,
                                                        inputs.mem, inputs.stype)
    novosort_sort_pe(novosort, sample, log_dir, t, mem, stype)
