...
if __name__ == "__main__":
    ...
    parser.add_argument('-st','--samtools',action='store',dest='sam', help='Location of samtools.')
    ...
    (STAR,sam,genome,end1,end2,sample,log_dir,th)=(inputs.star,inputs.sam,inputs.genome,inputs.end1,inputs.end2,inputs.sample,inputs.log_dir,inputs.th)
    star(STAR,sam,genome,end1,end2,sample,log_dir,th)
