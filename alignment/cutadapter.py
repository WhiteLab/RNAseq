...
if __name__ == "__main__":
    import argparse
    import sys
    parser=argparse.ArgumentParser(description='cutadapt module.  Removes 3\' adapters and trims bases if necessary.Also can enforce minimum read length - 20 recommended for tophat')
