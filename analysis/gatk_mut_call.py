...
def parse_config(json_config):
    ...
    try:
        return config_data['refs']['project'], config_data['refs']['align_dir'], config_data['params']['capture_flag'], \
...
def the_big_show(java, gatk, sample_list, th, fasta, recal_flag):
    ...
    for sample in sample_list:
        ...
        filt_vcf_cmd = java + ' -jar ' + gatk + ' -T VariantFiltration -R ' + fasta + ' -V ' + sample \
                       + '_haplo_calls.vcf  -window 35 -cluster 3 -filterName FS -filter "FS > ' \
