...
if __name__ == "__main__":
    import argparse
    parser=argparse.ArgumentParser(description='Bowtie2 paired-end alignment module.  Used for insert size estimation toward beginning using read subset.')
    ...
    (bwt_tool,bwt_ref,end1,end2,samtools_tool,samtools_ref,sample,t,log_dir)=(inputs.bwt_tool,inputs.bwt_ref,inputs.end1,inputs.end2,inputs.samtools_tool,inputs.samtools_ref,inputs.sample,inputs.t,inputs.log_dir)
